<script lang="ts">
	...
	import HeadingResult from '$lib/page/main/market/HeadingResult.svelte';
	import FilterBerdasarRight from '$lib/page/main/market/FilterBerdasarRight.svelte';
	import SearchingResult from '$lib/page/main/market/SearchingResult.svelte';
